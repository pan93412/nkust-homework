...
#question("Example 3.31 (#2)", <ex3.31-2>, ("相關係數", "共變異數"))[
  wip
][
  $
...
- 不論數據呈現何種分佈，至少有 $1-1/k^2 times 100%$ 的數據，會落在 $mu plus.minus k sigma$（樣本則為 $overline(x)$）範圍內。
...
#question("Example 3.27 (#2)", <ex3.27-2>, ("經驗法則",))[
  wip
][
  not done
]
