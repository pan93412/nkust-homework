...
#question("ex5.12")[
  ...
  + This is a repeated experiment, since there are $n=4$ questions.
...
#question("ex5.13")[
  ...
  + *抽取不放回 (without replacement)*：抽取第一顆球後不放回桶內，再抽取第二顆。
    + 此方式下，第一次抽取白球機率為 $10/15$，而在第一次抽取白球後，第二次抽取白球機率為 $9/14$；第一次抽取黑球機率為 $5/15$，而在第一次抽取黑球後，第二次抽取黑球機率為 $4/14$。故以此抽取不放回方式，並不符合二項分配。
...
#question("ex5.14")[
  ...
  $
  P(Y=1) = C^4_1 (1/5) times (4/5)^3 = (4/5)^4 = 0.4096
  $
