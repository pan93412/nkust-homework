...
#question("ex9.14")[
  在 #link(<ex9.13>)[例9.13] 中，試應用 $chi^2$ 檢定，在 $alpha=0.05$ 下，檢定該廠商之廣告宣稱是否值得採信？
][
  *Step 1: 虛無和對立假說*
...
#question("ex9.15")[
  ...
  *Step 3: 判斷是否落在拒絕域*
  ...
  $
  "p-value" &= P(s^2 > 0.012^2) \
            &= P((24 times s^2)/(sigma_0^2) > (24 times 0.012^2)/(0.01)^2) \
            &= P(chi > 34.56)
  $

  $P(chi > 34.56)$ 介於 $33.196$ (0.1) 和 $36.415$ (0.05) 之間。根據查表，其值應介於 $(0.05, 0.1)$，$"p-value" in.not R R$，故接受 $H_0$
