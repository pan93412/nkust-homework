...
#question("ex7.8")[
  假設一家製造公司在生產線上有 10% 的不良品，品質管理部門想要了解生產的品質優劣，因此隨機抽取了 100 個產品來檢測。令 $hat(p)$ 表示產品的檢測中被發現是不良品的比例，試問 $hat(p)$ 的抽樣分配，以及不良品的樣本比例在母體比例的 $plus.minus 0.05$ 之內的機率為何？
][
  *$hat(p)$ 的抽樣分配*
...
#question("ex7.11")[
  ...
  *Q2 Solution*
  ...
  $
  &P(8.52 < S^2 < 25.384) \
  =& P(((20-1)8.52)/16 < ((20-1)S^2)/16 < ((20-1)25.384)/16) \
  =& P(10.117 < chi^2 < 30.1435) \
  =& P(chi^2 > 10.117) - P(chi^2 > 30.1435)
  $

  根據表格，已知其自由度為 $19$，故查表後結果：
