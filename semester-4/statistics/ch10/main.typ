...
#question("ex10.10")[
  ...
  *計算方式*
  ...
  $
  (overline(D)"-分配" - mu_0) / (s_D/sqrt(n)) tilde t(n-1)
  $
  ...
  *Q4*
  ...
  $95% = 1-alpha, alpha=0.05, alpha/2=0.025$. $t_(alpha/2)$

  $
  c &= overline(D) plus.minus t_(alpha/2)(n-1) dot s_D/sqrt(n) \
    &= 3 plus.minus 2.3646 dot 1.1952/sqrt(8) \
    &= 0.6 or 5.4
  $
]
